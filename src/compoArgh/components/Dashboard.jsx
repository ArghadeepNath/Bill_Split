            ...
            <Card
              ...
              content={
                <>
                  <div>
                    Personal Money: $
                    {typeof financialData.personalMoney === "number"
                      ? financialData.personalMoney.toFixed(2)
                      : "N/A"}
                  </div>
                  <div>Total Owe: ${totalOwe.toFixed(2)}</div>
                  <div>Total Debt: ${typeof totalDebt === "number" ? totalDebt.toFixed(2) : "N/A"}</div>
                </>
              }
            />
            <h2>Debts</h2>
